...
public class CRData extends SavedData {
    ...
    public @NotNull CompoundTag save(@NotNull CompoundTag tag, HolderLookup.@NotNull Provider provider) {
        ...
        tag.put("fuze", fuze.save(provider));
        return tag;
    }

    public static CRData load(@NotNull CompoundTag tag, HolderLookup.@NotNull Provider provider) {
        ...
        data.pos = NbtUtils.readBlockPos(tag, "pos").orElse(BlockPos.ZERO);
        data.cooldown = tag.getInt("cooldown");
        data.fuze = ItemStack.parseOptional(provider, tag.getCompound("fuze"));
        return data;
    }
